  ...
  <body>
    <div class="container">
        <div class="row">
            ...
            $sql = "INSERT INTO `plantas`(`nome`, `nomeCientifico`, `quantidade`) VALUES ('$nome','$nomeCientifico','$quantidade')";

            if (mysqli_query($conn, $sql)){
                mensagem("$nome cadastrado", 'success');
            }else{
                mensagem("$nome não foi cadastrado, erro", 'danger');
            }
            ?>
            <hr>
