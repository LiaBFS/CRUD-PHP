    ...
    <div class="container">
        <div class="row">
            ...
            <div class="login"><br><br>
              ...
              <h1 class="tituloLogin">Realize o Login antes de acessar as funcionalidades:</h1><br>
              ...
              <form action="login_script.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Usuário" name="usuario" required><br>
                    </div>
